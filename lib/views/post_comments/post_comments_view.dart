...
import 'package:instagram_clone_course/state/comments/providers/post_comment_provider.dart';
...
class PostCommentsView extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final asyncComments = ref.watch(postCommentProvider(request.value));
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        children: [
          Expanded(
            flex: 4,
            child: AsyncValueWidget<Iterable<Comment>>(
              value: asyncComments,
              data: (comments) {
